...
public:
  ...
  //! \cond INTERNAL
  static constexpr uint32_t kMaxFeatures = 256;
  static constexpr uint32_t kNumBitWords = kMaxFeatures / Support::kBitWordSizeInBits;
  //! \endcond
  ...
  struct Data {
    ...
    inline Data& operator=(const Data& other) noexcept = default;
