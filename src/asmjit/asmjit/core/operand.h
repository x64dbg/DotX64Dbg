...
struct OperandSignature {
  ...
  // |........|........|........|.....XXX|
  static constexpr uint32_t kOpTypeShift = 0;
  static constexpr uint32_t kOpTypeMask = 0x07u << kOpTypeShift;

  // Register type (5 bits).
  // |........|........|........|XXXXX...|
  static constexpr uint32_t kRegTypeShift = 3;
  static constexpr uint32_t kRegTypeMask = 0x1Fu << kRegTypeShift;

  // Register group (4 bits).
  // |........|........|....XXXX|........|
  static constexpr uint32_t kRegGroupShift = 8;
  static constexpr uint32_t kRegGroupMask = 0x0Fu << kRegGroupShift;

  // Memory base type (5 bits).
  // |........|........|........|XXXXX...|
  static constexpr uint32_t kMemBaseTypeShift = 3;
  static constexpr uint32_t kMemBaseTypeMask = 0x1Fu << kMemBaseTypeShift;

  // Memory index type (5 bits).
  // |........|........|...XXXXX|........|
  static constexpr uint32_t kMemIndexTypeShift = 8;
  static constexpr uint32_t kMemIndexTypeMask = 0x1Fu << kMemIndexTypeShift;

  // Memory base+index combined (10 bits).
  // |........|........|...XXXXX|XXXXX...|
  static constexpr uint32_t kMemBaseIndexShift = 3;
  static constexpr uint32_t kMemBaseIndexMask = 0x3FFu << kMemBaseIndexShift;

  // This memory operand represents a home-slot or stack (Compiler) (1 bit).
  // |........|........|..X.....|........|
  static constexpr uint32_t kMemRegHomeShift = 13;
  static constexpr uint32_t kMemRegHomeFlag = 0x01u << kMemRegHomeShift;

  // Immediate type (1 bit).
  // |........|........|........|....X...|
  static constexpr uint32_t kImmTypeShift = 3;
  static constexpr uint32_t kImmTypeMask = 0x01u << kImmTypeShift;

  // Predicate used by either registers or immediate values (4 bits).
  // |........|XXXX....|........|........|
  static constexpr uint32_t kPredicateShift = 20;
  static constexpr uint32_t kPredicateMask = 0x0Fu << kPredicateShift;

  // Operand size (8 most significant bits).
  // |XXXXXXXX|........|........|........|
  static constexpr uint32_t kSizeShift = 24;
  static constexpr uint32_t kSizeMask = 0xFFu << kSizeShift;
...
struct BaseRegTraits {
  ...
  static constexpr TypeId kTypeId = TypeId::kVoid;
  ...
  static constexpr RegType kType = RegType::kNone;
  //! Zero group by default (defaults to GP).
  static constexpr RegGroup kGroup = RegGroup::kGp;
  //! No size by default.
...
public:
  static constexpr uint32_t kBaseSignatureMask =
    Signature::kOpTypeMask   |
    Signature::kRegTypeMask  |
    Signature::kRegGroupMask |
    Signature::kSizeMask     ;

  static constexpr RegType kTypeNone = RegType::kNone;
  static constexpr uint32_t kSignature = Signature::fromOpType(OperandType::kReg).bits();
...
//! Either forwards operand T or returns a new operand for T if T is a type convertible to operand. At the moment
//! this is only used to convert integers to \ref Imm operands.
template<typename T>
