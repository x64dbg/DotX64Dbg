...
public:
  ...
  inline Error embedFloat(float value, size_t repeatCount = 1) { return embedDataArray(TypeId::kFloat32, &value, 1, repeatCount); }
  //! Embeds a floating point `value` repeated by `repeatCount`.
  inline Error embedDouble(double value, size_t repeatCount = 1) { return embedDataArray(TypeUtils::TypeIdOfT<double>::kTypeId, &value, 1, repeatCount); }
